...
//  Core Content
//
//  Created by Jamie Klapwyk on 2021-08-04.
//
...
extension View {
    func swipeActions(id: String,
                      disableSwipe: Binding<Bool>,
                      trailing: [SwipeActionButton] = [],
                      onSwipeStart: (()->Void)?) -> some View {
        modifier(SwipeActionView(id:id,
                                 disableSwipe: disableSwipe,
                                 trailing: trailing,
                                 onSwipeStart: onSwipeStart))
    }
    
//    func addSearchBar(hideSearch:Binding<Bool> = .constant(false),
//                      showingSearchScreen:Binding<Bool> = .constant(false),
//                      searchNodeId:String = "",
//                      searchNodeName:String = "",
//                      searchingNode:FileItemData? = nil,
//                      textToSearchFor:String = "" ,
//                      isSearchScreen:Bool = false,
//                      onEditingChange:((String) -> Void)? = nil,
//                      onSearch:((String) -> Void)? = nil,
//                      searchType:InlineSearchType = .fileScreen) -> some View {
//
//        modifier(SearchBarView(hideSearch: hideSearch,
//                               showingSearchScreen: showingSearchScreen,
//                               searchNodeId: searchNodeId,
//                               searchNodeName: searchNodeName,
//                               parentNode: searchingNode,
...
//    }
    ...
    func addInlineSearchView(hideSearch:Binding<Bool> = .constant(false), showCreatePin:Binding<Bool> = .constant(false), animatingArrow:Binding<Bool> = .constant(false), searchType:InlineSearchType, isSelectionMode:Binding<Bool> = .constant(false), searchingNode: FileItemData? = nil) -> some View {
        modifier(InlineSearchViewModifier(hideSearch: hideSearch, showCreatePin: showCreatePin, animatingArrow: animatingArrow, searchingNode: searchingNode, searchType: searchType, isSelectionMode: isSelectionMode))
    }
    
//    func addHomeAcceabilityModifier(With hideSearch:Binding<Bool> = .constant(false)) -> some View {
//        modifier(InlineSearchViewModifier(hideSearch: hideSearch))
//    }
    
    func addMessagesContainer() -> some View {
        modifier(BannerMessagesView())
    }
    
    func addInlineMessageView(hideView:Binding<Bool> = .constant(false)) -> some View {
        modifier(InlineMessagesView(hideView: hideView))
    }
    
    func handleSimultaneiousTouches(isInputFocused:Binding<Bool> = .constant(false)) -> some View {
        modifier(SimultaniousTapGestureHandler(isInputFocused:isInputFocused))
    }
    
    func addCreatePinOfflineView(hideSetUpCreatePin:Binding<Bool> = .constant(false)) -> some View {
        modifier(SetupCreatePinView(hideSetUpCreatePin: hideSetUpCreatePin))
    }
    
    func addAnimation(shouldAddAnimation: Binding<Bool>, animation:Animation?) -> some View {
        modifier(AnimationHandlerView(shouldAddAnimation: shouldAddAnimation, animation: animation))
    }
